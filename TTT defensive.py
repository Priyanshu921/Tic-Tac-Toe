...
def cturn():
    if(((board[0]==select and board[1]==select) or (board[6]==select and board[4]==select)or(board[8]==select and board[5]==select))and board[2]==0):
        y=2
    elif(((board[1]==select and board[2]==select) or (board[8]==select and board[4]==select) or(board[6]==select and board[3]==select))and board[0]==0):
        y=0
    elif(((board[4]==select and board[7]==select) or (board[0]==select and board[2]==select))and board[1]==0):
        y=1  
    elif(((board[0]==select and board[6]==select) or (board[4]==select and board[5]==select))and board[3]==0):
        y=3  
    elif(((board[0]==select and board[8]==select) or (board[6]==select and board[2]==select)or(board[7]==select and board[1]==select))and board[4]==0):
        y=4
    elif(((board[2]==select and board[8]==select) or (board[4]==select and board[3]==select))and board[5]==0):
        y=5
    elif(((board[2]==select and board[4]==select) or (board[0]==select and board[3]==select)or(board[7]==select and board[8]==select))and board[6]==0):
        y=6
    elif(((board[1]==select and board[4]==select) or (board[6]==select and board[8]==select))and board[7]==0):
        y=7
    elif(((board[0]==select and board[4]==select) or (board[6]==select and board[7]==select)or(board[2]==select and board[5]==select))and board[8]==0):
        y=8
    else:
